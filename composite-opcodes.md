...
btcdeb "[ 
	...
	IF 1073741824 SUB ENDIF

	DUP 536870912 GREATERTHANOREQUAL
	IF 536870912 SUB ENDIF

	DUP 268435456 GREATERTHANOREQUAL
	IF 268435456 SUB ENDIF

	DUP 134217728 GREATERTHANOREQUAL
	IF 134217728 SUB ENDIF

	DUP 67108864 GREATERTHANOREQUAL
	IF 67108864 SUB ENDIF

	DUP 33554432 GREATERTHANOREQUAL
	IF 33554432 SUB ENDIF
	
	DUP 16777216 GREATERTHANOREQUAL
	IF 16777216 SUB ENDIF
	

	# Now the first 8 bits are zero
# ]"
```
