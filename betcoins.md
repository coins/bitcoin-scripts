...
Betcoins is a protocol for trustless Bitcoin bets. It works on todays Bitcoin. It allows any bet sizes, any discrete probability distributions and any payout sizes. It can be generalized to an election of a random leader.
